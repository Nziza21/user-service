...
This is a User Management Service API built with Go and Gin, providing functionality to manage users, including creating, reading, updating, and deleting user accounts. It includes role-based access control (admin-only endpoints) and JWT authentication.
